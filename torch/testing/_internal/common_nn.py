...
new_module_tests = [
    ...
    dict(
        ...
        cpp_input_args=['torch::randn({3, 2, 5})'],
        constructor_args=(2.,),
        cpp_constructor_args='torch::nn::CELUOptions(2.)',
        check_inplace=True,
...
criterion_tests = [
    ...
    dict(
        ...
        cpp_target_args=['torch::empty({15}).uniform_().mul(10).floor().long()'],
    ...
    dict(
        ...
        cpp_target_args=['torch::randn({15, 10}).gt(0).double()'],
    ...
    dict(
        ...
        cpp_target_args=['torch::randn({10}).gt(0).double().mul_(2).sub(1)'],
        reference_fn=lambda i, t, m:
    ...
    dict(
        ...
        cpp_target_args=['torch::rand(10).mul(10).floor().long()'],
        reference_fn=lambda i, t, m:
    ...
    dict(
        ...
        cpp_target_args=['torch::rand({5, 10}).mul(10).floor().long()'],
        reference_fn=lambda i, t, m:
            multilabelmarginloss_reference(i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        check_gradgrad=False,
    ...
    dict(
        ...
        cpp_target_args=['torch::rand(5).mul(8).floor().long()'],
        reference_fn=lambda i, t, m:
    ...
    dict(
        ...
        cpp_target_args=['torch::rand(1).mul(8).floor().long()'],
        reference_fn=lambda i, t, m:
            multimarginloss_reference(i, t, reduction=get_reduction(m)),
        desc='1d',
        check_sum_reduction=True,
...
new_criterion_tests = [
    ...
    dict(
        ...
        cpp_target_args=['torch::randn({}).gt(0).double()'],
        desc='scalar_weights'
    ),
    dict(
        module_name='NLLLoss',
        ...
        cpp_target_args=['torch::rand({2, 5, 5}).mul(3).floor().long()'],
        reference_fn=lambda i, t, m:
    ...
    dict(
        ...
        cpp_target_args=['torch::rand({2, 5, 5, 2, 2}).mul(3).floor().long()'],
        reference_fn=lambda i, t, m:
            loss_reference_fns['NLLLossNd'](i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        desc='higher_dim',
    ...
    dict(
        ...
        cpp_target_args=['torch::rand({2, 5}).mul(3).floor().long()'],
        reference_fn=lambda i, t, m:
            loss_reference_fns['NLLLossNd'](i, t, reduction=get_reduction(m)),
        check_sum_reduction=True,
        desc='dim_is_3',
    ...
    dict(
        ...
        cpp_target_args=['torch::rand({}).gt(0).double()'],
        reference_fn=lambda i, t, m: -((t * i.log() + (1 - t) * (1 - i).log()) * get_weight(m)).sum() /
            (i.numel() if get_reduction(m) == 'mean' else 1),
        desc='scalar_weights',
        check_gradgrad=False,
    ...
    dict(
        ...
        cpp_target_args=['torch::randn({}).gt(0).double().mul_(2).sub(1)'],
        desc='scalar_margin',
        check_sum_reduction=True,
    ),
    dict(
